...
class JobPostServiceTest extends IntegrationTest {
	...
	void searchJobPost() {
		...
		List<GetJobPostCommandResponse> result1 = jobPostService.searchAllJobPost(searchCommand1);
		List<GetJobPostCommandResponse> result2 = jobPostService.searchAllJobPost(searchCommand2);
