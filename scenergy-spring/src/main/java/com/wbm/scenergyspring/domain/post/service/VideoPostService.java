...
import com.wbm.scenergyspring.domain.post.service.command.*;
    ...
    public List<VideoPostCommandResponse> getAllVideoPost() {
        ...
        for (VideoPost videoPost : videoPostRepository.findAll()) {
            VideoPostCommandResponse command = VideoPostCommandResponse.builder()
                    ...
                    .genreTags(videoPost.createVideoPostGenreTagCommand())
                    .instrumentTags(videoPost.createVideoPostInstrumentTagCommand())
                    .build();
...
//    }
    ...
    public VideoPost createVideoPost(VideoPostCommand command){
        ...
        createVideoPostGenreTags(command.getGenreTagIds(), videoPost);
        createVideoPostInstrumentTag(command.getInstrumentTagIds(), videoPost);
        return videoPost;
    }
    ...
    @Transactional(readOnly = false)
    public boolean updateVideoPost(UpdatePostVideoRequest request) {
        ...
        UpdateVideoPostCommand command1 = request.videoPostUpdateCommand();
